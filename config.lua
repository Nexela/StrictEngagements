...
SE.ALLOWED = {"car", "land-mine", "combat-robot"}

--Turret Types. To allow turrets of a certain type or name add them to the following list.
SE.TURRETS = {"electric-turret", "ammo-turret", "fluid-turret"}
